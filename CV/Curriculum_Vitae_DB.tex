...
% \noindent
% \begin{minipage}[t]{0.4\textwidth}
%     \raggedright \textbf{2403317}
% \end{minipage}%
% \begin{minipage}[t]{0.3\textwidth}
%     \centering Rex (PI)
% \end{minipage}%
% \begin{minipage}[t]{0.3\textwidth}
%     \raggedleft 8/15/2024 -- 7/31/2028
% \end{minipage}
% \\[.2em]
% NSF -- IIS \hfill \$799,941\\[.2em]
% ``Contextualized and Multimodal Foundation Models for Graph Data in Scientific Discovery"\\[.2em]
% \ul{Role:} Collaborator {\small (contributed to Intellectual Merit, Broader Impacts, and Preliminary Work)}
...
\end{minipage}%
\begin{minipage}[t]{0.3\textwidth}
    \raggedleft 1/1/2020 -- 12/31/2020
\end{minipage}
\\[.2em]
...
% \textbf{Summary:} Summary goes here.
...
% \item[] \hspace{.3cm} Workshops:
% \begin{list2}
% \setlength\itemsep{0.15em}
% \setlength{\itemindent}{.7cm}
% \item Teaching First-Generation Low-Income Students
% \item Teaching International Students
% \item Antiracist Pedagogy
% \item Participation and Equity
% \end{list2}
...
% \item[] {\bf Students:} Drew Steindl, Ellen Zhang, Ellie Schueler, Elliott Abel, Folu Ogundipe, Selma Mazioud, Kristof Reimann, Yvan Grinspan
% \end{list1}
% \vspace*{.3cm}
% \begin{list1}
% \setlength\itemsep{0.2em}
...
% \begin{list1}
% \setlength\itemsep{0.2em}
% \item[] {\bf Topic:} Drug Discovery using Geometric Deep Learning \hfill {\bf \small Summer 2021}
% \item[] {\bf Student:} Jackson Grady (Yale College, BS'23) 
% \end{list1}
% \vspace*{.3cm}
% \begin{list1}
% \setlength\itemsep{0.2em}
...
\newpage
\begin{flushright}
\textit{Curriculum Vitae} - Dhananjay Bhaskar - Page 6/8
\end{flushright}
%\vspace*{.1cm}
...
\newpage
\begin{flushright}
\textit{Curriculum Vitae} - Dhananjay Bhaskar - Page 7/8
\end{flushright}
